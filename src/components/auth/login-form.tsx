  ...
  return (
    <>
      ...
      <div className="mt-2 grid grid-cols-1 gap-4">
        <Button
          className="!bg-transparent !text-social-google hover:!text-light hover:!bg-social-google-hover rounded-none border-2 border-social-google"
          disabled={isLoading}
          onClick={() => {
            signIn('google');
          }}
        ...
        <Button
          className="!bg-transparent h-11 w-full hover:!bg-gray-500 !text-gray-500 hover:!text-light  sm:h-12 rounded-none border-2 border-gray-500"
          disabled={isLoading}
          onClick={() => openModal('OTP_LOGIN')}

        >
          <MobileIcon className="h-5 ltr:mr-2 rtl:ml-2" />
          {t('text-login-mobile')}
        </Button>

        {isCheckout && (
          <Button
            className="!bg-transparent h-11 w-full hover:!bg-pink-700 !text-pink-700 hover:!text-light  sm:h-12 rounded-none border-2 border-pink-700"
            disabled={isLoading}
