...
const UserList = ({
    ...
    let columns = [
        ...
        },
        {
            ...
            render: (company: Company) => (
                <span className="truncate whitespace-nowrap">{company?.name}</span>
            ),
        },
        // {
        //   title: 'Product Type',
    ...
    return (
        <>
            <div className="mb-6 overflow-hidden rounded border border-border-200 bg-light px-10 py-8">
                <Table
                    /* @ts-ignore */
                    columns={columns}
