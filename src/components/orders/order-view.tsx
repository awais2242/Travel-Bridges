              ...
              {!isEmpty(order?.shipping_address) && (
                <p className="mt-5 flex text-body-dark">
                  ...
                  <span className="w-8/12 text-sm ltr:pl-4 rtl:pr-4 ">
                    ...
                    {order?.shipping_address.title ? formatAddress(order?.shipping_address.address!) : formatAddress(order?.shipping_address!)}
                  </span>
                </p>
              )}
              {!isEmpty(order?.billing_address) && (
                <p className="mt-5 flex text-body-dark">
                  ...
                  <span className="w-8/12 text-sm ltr:pl-4 rtl:pr-4">
                    ...
                    {order?.billing_address.title ? formatAddress(order?.billing_address.address!) : formatAddress(order?.billing_address!)}
...
export default function Order() {
  ...
  return <OrderView order={order} language={order?.language} />;
}
