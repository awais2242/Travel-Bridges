    ...
    <div>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center  py-3 sm:space-y-1 lg:flex-row lg:space-y-0 lg:py-0">
            <div className="w-full shrink-0 ltr:sm:pl-8 ltr:sm:pr-5 rtl:sm:pl-5 rtl:sm:pr-8 lg:w-auto lg:py-5 ">
              <Sorting />
            </div>
            <div className="w-full shrink-0 ltr:sm:pl-8 ltr:sm:pr-5 rtl:sm:pl-5 rtl:sm:pr-8 lg:w-auto lg:py-5 ">
              <StarFilter />
