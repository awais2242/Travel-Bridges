      ...
      <div className={className}>
        ...
        <div className="relative">
          <input
            ...
            ref={ref}
            className={cn(
              'py-3 ltr:pl-4 rtl:pr-4 ltr:pr-11 rtl:pl-11 w-full rounded-none appearance-none transition duration-300 ease-in-out text-heading text-sm focus:outline-none focus:ring-0',
              shadow && 'focus:shadow',
