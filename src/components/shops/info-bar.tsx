    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'bg-light h-full w-full  hidden lg:block',
          className
        )}
      >
        <div className="max-h-full overflow-hidden">
            <div className="flex flex-col items-center w-full border-b border-gray-200 p-7">
              <div className="relative h-full w-full overflow-hidden container mx-auto">
                <Image
                  alt={t('heading')}
              ...
              <div className="relative mx-auto mb-8 -mt-20 overflow-hidden bg-gray-200 border-8 border-gray-100 w-44 h-44">
                <Image
                  alt={t('logo')}
                  src={shop?.logo?.original! ?? productPlaceholder}
                  layout="fill"
