...
import { ConfidenceIcon } from '../icons/confidence';
...
const FooterNew = () => {
  ...
  return (
    <>
      <div className="hidden w-full flex-col bg-white px-5 md:px-10 lg:px-[50px] xl:px-16 border-t-2">

        <div className='container mx-auto mb-8 lg:mb-0'>
          {/* Top Icons */}
          <div className="grid w-full grid-cols-[repeat(auto-fill,minmax(260px,1fr))] gap-6 pt-12 md:grid-cols-3 lg:pt-16 lg:pb-16 xl:grid-cols-[repeat(auto-fill,minmax(220px,1fr))] xl:gap-8 2xl:grid-cols-5 divide-x">
            ...
            <div className="grid grid-cols-1 text-center">
              ...
              <ul className="space-y-3 px-2">
                ...
                <li className="mt-3 mb-4 font-semibold text-heading lg:mb-7">
                  Great value
                </li>
                <li>{t('text-great-value')}</li>
              </ul>
            </div>
            <div className="grid grid-cols-1 text-center">
              ...
              <ul className="space-y-3 px-2">
                ...
                <li>{t('text-worldwide-shopping')}</li>
              </ul>
            </div>
            <div className="grid grid-cols-1 text-center">
            ...
            <div className="grid grid-cols-1 text-center">
              ...
              <ul className="space-y-3 px-2">
                ...
                <li>{t('text-shop-with-confidence')}</li>
              </ul>
            </div>
            <div className="grid grid-cols-1 text-center">
      ...
      <div className="flex w-full flex-col border-gray-300 bg-white px-5 md:px-10 lg:border-b-8 lg:px-[50px] xl:px-16 border-t">
